  ...
  <div class="card m-5 shadow-sm mb-4" id="detailMurid">
      ...
      <a href="<?= base_url('mutasi/option_detail_haid/') . $getSiswiById['nisn_id']; ?>" class="btn btn-primary btn-sm text-white"><i
          ...
          <a href="<?= base_url('mutasi/laporan_haid_pdf_xi/') . $getSiswiById['nisn_id'] ; ?>" target="_blank"
          ...
          <div class="card">
              <div class="card-body text-center">
                  ...
                  <a href="<?= base_url("mutasi/detail_haid_xi/") . $getSiswiById['nisn_id'];  ?>"
                      class="btn btn-light shadow-sm">Haid Kelas XI</a>
