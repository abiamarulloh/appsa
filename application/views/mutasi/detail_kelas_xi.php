...
<div class="card m-3 shadow-sm mb-4" id="detailMurid">
    <div class="card-header py-3">
        ...
        <a href="<?= base_url('mutasi/laporan_poin_pdf_xi/') . $getMuridKelasJurusanById['nisn_id'] ; ?>" target="_blank" class="btn btn-success btn-sm mr-5 float-right"><i class="fas fa-fw fa-file-export"></i> Export PDF</a>
        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <a href="<?= base_url("mutasi/detail_kelas_xi/") . $getMuridKelasJurusanById['nisn_id'];  ?>" class="btn btn-light shadow-sm">Data Kelas XI</a>

                <a href="<?= base_url("mutasi/detail_kelas_xii/") . $getMuridKelasJurusanById['nisn_id'];  ?>" class="btn btn-primary">Data Kelas XII</a>
