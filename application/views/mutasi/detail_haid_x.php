  ...
  <div class="card m-5 shadow-sm mb-4" id="detailMurid">
      <div class="card-header py-3">
          ...
          <a href="<?= base_url('mutasi/option_detail_haid/') . $getSiswiById['nisn_id']; ?>"
              class="btn btn-primary btn-sm text-white"><i class="fas fa-arrow-circle-left"></i> Kembali ke data
              haid</a>

          <a href="<?= base_url('mutasi/laporan_haid_pdf_x/') . $getSiswiById['nisn_id'] ; ?>" target="_blank"
              class="btn btn-info mr-5 btn-sm float-right"><i class="fas fa-fw fa-file-export"></i> Export to PDF</a>


          <!-- <a href="<?= base_url('mutasi/tambah_haid/') . $getSiswiById['nisn_id'] ; ?>" class="btn btn-success btn-sm "><i
