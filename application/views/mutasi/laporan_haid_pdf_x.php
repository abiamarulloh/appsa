    ...
    <div class="table-responsive">
            ...
            <thead>
                <tr>
                    <td class="p-1 border-top-0 border-bottom-0 font-weight-bold">
                        <h6 class="font-weight-bolder text-left text-uppercase" style="font-size:11px">Absen Pagi hari</h6>
                    </td>
                </tr>
        ...
        <table class="table">
            <thead>
                <tr>
                    <td class="p-1 border-top-0 border-bottom-0 font-weight-bold">
                        <h6 class="font-weight-bolder text-left text-uppercase" style="font-size:11px"> Absen Siang hari</h6>
                    </td>
                </tr>
                <tr class="text-center">
                    <td class="p-1 border-top-0 border-bottom font-weight-bold" style="font-size:10px">Tanggal Haid</td>
