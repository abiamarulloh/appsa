            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <small class="bg-primary text-white">
                        Catatan : Pilih tahun kelulusan murid untuk melihat daftar murid beserta poinnya.
                    </small>
                    <hr>
                    ...
                    <form action="" method="post">
                        ...
                        <button type="submit" class="btn btn-primary mb-2 btn-block">Lihat data Murid</button>
